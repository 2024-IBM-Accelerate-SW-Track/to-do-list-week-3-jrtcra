      ...
      return (
        <Grid key={todo.id}>
          <Card style={{marginTop:10, background:color}}>
            ...
            <ListItemButton component="a" href="#simple-list" data-testid={todo.content}>
              <Checkbox style={{paddingLeft:0}} color="primary" onClick={() => deleteTodo(todo.id)}/>
              <ListItemText primary={todo.content} secondary={todo.due} data-testid={"todo-test"}/>
            </ListItemButton>
          </Card>
        </Grid>
      );
